...
export const DIALOGUES = {
  ...
  intro_welcome: {
    ...
    lines: [
      ...
      { speaker: '???', portrait: '\u{1F392}', portraitKey: 'poco', text: '조용히 해, 꼬맹이! 식란이 시작됐어!' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '나는 포코. 네 할머니의 오랜 협력자지.' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '식란... 음식의 미력이 폭주해서 재료가 괴물로 변하는 현상이야.' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '미력? 식란? 무슨 소리야 대체?!' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '네 할머니는 미력사였어. 조리 도구로 폭주한 식재료를 정화하는 비밀 요리사.' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '그리고 너도 그 혈통이야. 이 프라이팬 잡아봐.' },
      ...
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '역시! 미력사의 피는 못 속이는군!' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '자, 이제부터 낮에는 식당 운영, 밤에는 식란 정화! 바쁘겠다~' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '잠깐, 나 아직 동의 안 했는데?!' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '아 참, 내 도구들도 좀 사줘. 정화에 꼭 필요하거든. 할인은 없어!' },
    ]
  },
  merchant_first_meet: {
    ...
    skippable: true,
    lines: [
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '야호~ 영업은 잘 됐어? 싱싱한 정화 도구 들고 왔다!' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '포코! 이 프라이팬 왜 이렇게 비싸? 정화 도구라며!' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '미력이 깃든 도구는 원래 비싼 거야. 장인의 손맛이 들어갔거든!' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '게다가 이 프라이팬으로 폭주한 양파를 패면... 아, 정화하면!' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '싱싱한 양파가 되어 돌아온다고! 거의 자급자족 아닌가?' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '패면... 이라고 할 뻔 했지?' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '정화라니까! 고급스러운 정화!' },
  ...
  stage_first_clear: {
    ...
    lines: [
      ...
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '오호, 초보 미력사 치고는 솜씨가 있는데?' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '초보라고 하지 마! 원래 요리학교 수석이었다고!' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '요리 실력이랑 식란 정화는 좀 다른데... 뭐, 결과가 좋으니까.' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '정화된 재료들 봐. 전부 싱싱해! 내일 영업에 쓰면 되겠다.' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '밤새 싸우고 낮에 요리라니... 이게 할머니의 일상이었구나.' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '할머니 식당... 어쩌면 진짜 되살릴 수 있을지도?' },
  ...
  chapter1_start: {
    ...
    lines: [
      ...
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '그 자신감 좋은데... 일단 당근들이 몇 마리나 오는지 알고 가자.' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '몇 마리?! 당근이 떼거리로 오는 거야?!' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '식란은 규모가 클수록 많이 오지. 오늘은... 음, 좀 많다.' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '됐어! 프라이팬 꽉 잡고 간다!' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '아 참, 그 프라이팬 지금 업그레이드하면 20% 할인인데—' },
  ...
  chapter1_clear: {
    ...
    lines: [
      ...
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '파스타 보스가 꽤 질겼는데? 면발이 칼날처럼 날아오더만.' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '솔직히 면발에 맞을 뻔 했어... 탄력이 장난 아니었다고!' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '하지만 정화된 파스타 면은 최고급이야! 오늘 메뉴에 올려봐.' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '방금 나한테 달려들던 녀석을 요리에 쓰라고?' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '그게 미력사의 길이지~ 정화해서 쓰는 거야. 에코 라이프!' },
  ...
  chapter2_intro: {
    ...
    lines: [
      ...
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '(속삭임) 저 아이... 유명한 불꽃 미력사 가문의 후계자야.' },
      ...
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '아이고... 둘 다 불이야 불. 프라이팬 태우지 말고...' },
    ]
  },
  rin_first_meet: {
    id: 'rin_first_meet',
    ...
    lines: [
      ...
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '경쟁은 좋은 거야~ 참, 불꽃 미력사용 도구도 있는데—' },
  ...
  mage_introduction: {
    ...
    lines: [
      ...
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '연구원이라... 식란의 원인을 조사 중인 거야?' },
  ...
  poco_discount_fail: {
    ...
    lines: [
      ...
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '단골? 두 번 온 걸로 단골이라고?' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '두 번이면 충분하지! VIP 대우 해줘!' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '내 VIP 기준은 최소 100회 구매야. 아직 98회 남았어.' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '그건 평생 할인 안 해주겠다는 소리잖아!!' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '에이~ 그래도 맛있는 정보는 공짜로 줄게.' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '도구 레벨을 올리면 정화 효율이 훨씬 좋아진다는 거!' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '그건 이미 알아!! 업그레이드 비용이나 깎아줘!!' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '하하... 다음에 또 와~' },
    ]
  },
  stage_boss_warning: {
    ...
    skippable: true,
    lines: [
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '잠깐! 이 구역에서 엄청난 미력이 느껴져...' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '엄청난 미력? 보스급 식란이라는 거야?' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '맞아. 보스급 식재료는 일반 녀석들과 차원이 다르거든.' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '체력도 높고, 특수 능력도 있어. 도구 배치를 신중하게 해야 해.' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '알겠어! 프라이팬 최대 화력으로 간다!' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '무작정 화력만으론 안 돼! 다양한 도구를 조합해 봐.' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '...참, 보스전 전용 프리미엄 도구 세트가 지금 할인—' },
  ...
  after_first_loss: {
    ...
    lines: [
      ...
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '괜찮아, 괜찮아. 첫술에 배부를 순 없는 법이야.' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '할머니는 이런 적 없었겠지...' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '무슨 소리! 네 할머니도 처음엔 매일 실패했어.' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '한번은 당근 한 마리한테 쫓겨서 식당 지붕까지 도망간 적도 있다고.' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '정말?! 할머니가?!' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '진짜야. 그래도 포기 안 했으니까 이 식당이 있는 거지.' },
      { speaker: '미미', portrait: '\u{1F467}', portraitKey: 'mimi', text: '...그래. 나도 포기 안 해! 다시 해보자!' },
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '그 정신이야! 도구 보강도 생각해 보고~ 특별 세일은 안 하지만!' },
    ]
  },
  chapter3_rin_joins: {
    ...
    lines: [
      ...
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '오호~ 린이 칭찬을 하다니! 이건 역사적인 순간이야.' },
      ...
      { speaker: '포코', portrait: '\u{1F392}', portraitKey: 'poco', text: '츤데레는 빼고 말해~ 환영해, 린!' },
...
export const CHARACTERS = {
  ...
  poco: { id: 'poco', nameKo: '포코', portrait: '\u{1F392}', portraitKey: 'poco', color: 0xffaa33, role: 'merchant', desc: '정화 도구 전문 장인. 미력사 가문의 오랜 협력자.' },
