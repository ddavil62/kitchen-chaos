...
export const DIALOGUES = {
  ...
  chapter16_mid: {
    ...
    lines: [
      ...
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '(낮고 단호한 목소리로) 멈춰라. 이 구역은 외부인 출입 금지다.' },
      { speaker: '미미', portrait: '👧', portraitKey: 'mimi', text: '누, 누구야?! 갑자기 나타나서!' },
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '우리는 마살라 문파. 이 시장의 식란을 대대로 다스려온 자들이다. 당신들은 누구이고, 무슨 목적으로 왔나.' },
      { speaker: '앙드레', portrait: '🥐', portraitKey: 'andre', text: '(한 걸음 앞으로 나서며) 저희는 WCA 소속 미력사입니다. 새로운 식란 징후를 추적해왔습니다.' },
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '(비웃듯) WCA? 유럽 미력사들이 인도까지 왔군. 우리 일에 간섭하려고?' },
      { speaker: '라오', portrait: '🐉', portraitKey: 'lao', text: '(팔짱을 끼며) 식란이 국경을 알겠어? 혼자 다 막을 수 있다면 진작 막았겠지.' },
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '(잠시 침묵) ...말이 거칩구나, 중국인. 하지만 틀린 말은 아니야.' },
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '지금 당장 협력하겠다는 건 아니다. 하지만 쫓아내지도 않겠다. 일단... 지켜보겠어.' },
  ...
  chapter16_epilogue: {
    ...
    lines: [
      ...
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '(낮은 목소리로) 거기까지 들어가려면… 각오가 있어야 한다. 그 안에 있는 것은 우리도 오래 봉인해온 것이다.' },
      { speaker: '라오', portrait: '🐉', portraitKey: 'lao', text: '봉인이 풀리고 있다는 뜻이야?' },
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '그렇다. 그래서 너희가 온 것이 운이 좋다고 생각하기 시작했다.' },
  ...
  chapter17_intro: {
    ...
    lines: [
      ...
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '수백 년 전, 우리 조상이 미력을 담은 향신료들을 봉인해 쌓아온 장소다. 그것이 지금 풀려나고 있다.' },
      { speaker: '유키', portrait: '❄️', portraitKey: 'yuki', text: '(주위를 살피며) 내부에서 누군가 건드렸다는 흔적이 있습니다. 봉인이 저절로 풀리지 않아요.' },
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '(표정이 굳으며) …맞다. 안에서부터 열린 것이다. 우리가 알아채지 못한 사이에.' },
      { speaker: '앙드레', portrait: '🥐', portraitKey: 'andre', text: '누가 이걸 열 수 있는 겁니까? 마살라 문파 외부 인물이?' },
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '(긴 침묵 후, 낮게) …그 이름을 입에 올리고 싶지 않지만. 마하라자. 그 이름이 떠오른다.' },
      { speaker: '미미', portrait: '👧', portraitKey: 'mimi', text: '마하라자? 누구야?' },
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '나중에 설명하겠다. 지금은 먼저 이 안을 정화해라.' },
    ],
  },
  ...
  chapter17_mid: {
    ...
    lines: [
      ...
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '(표정이 굳으며) …그건 마하라자의 인장이다.' },
      { speaker: '앙드레', portrait: '🥐', portraitKey: 'andre', text: '마하라자. 아까 그 이름이군요. 설명해줄 수 있습니까?' },
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '300년 전, 우리 문파에서 추방된 미력사다. 향신료의 미력을 무기로 바꾸려 했다. 정화가 아닌 — 지배를.' },
      { speaker: '라오', portrait: '🐉', portraitKey: 'lao', text: '(차갑게) 추방됐다면 이미 죽었을 텐데.' },
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '그가 죽었는지는 모른다. 하지만 이 인장은… 그의 기술로 다시 새겨진 것이다. 누군가가 그의 방법을 재현했다.' },
      { speaker: '미미', portrait: '👧', portraitKey: 'mimi', text: '추종자가 있다는 거야?' },
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '(고개를 끄덕이며) 그리고 그들이 이 금고를 열고, 안에 잠든 것을 깨우려 하고 있다.' },
      { speaker: '포코', portrait: '🐱', portraitKey: 'poco', text: '(긴장된 표정으로) 안에 잠든 게 뭔데?' },
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '금고의 수호자. 봉인이 풀리면 — 그것이 깨어난다. 다음 층에서 마주칠 것이다.' },
  ...
  chapter18_intro: {
    ...
    lines: [
      ...
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '...여기까지 와줬으니 이제 말해야겠어.' },
      { speaker: '미미', portrait: '👧', portraitKey: 'mimi', text: '아르준 씨?' },
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '내 이름은 아르준. 마살라 문파 12대 계승자야. 17장 내내 이름을 숨긴 건... 이 봉인이 풀리는 걸 막지 못할 경우를 대비해서였어.' },
  ...
  chapter18_epilogue: {
    ...
    lines: [
      ...
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '...끝났어. 300년 동안 우리 문파를 짓눌렀던 것이.' },
  ...
  team_side_18: {
    ...
    lines: [
      ...
      { speaker: '아르준', portrait: '🪬', portraitKey: 'arjun', text: '...어느 순간부터 익숙해졌어.' },
