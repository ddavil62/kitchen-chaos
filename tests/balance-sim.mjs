...
const STAGES = [
  ...
  { id:'2-2', ch:2, waves:[ {e:[{t:'fish_knight',c:8},{t:'mushroom_scout',c:6}]}, {e:[{t:'cheese_rat',c:10},{t:'carrot_goblin',c:12}]}, {e:[{t:'fish_knight',c:10},{t:'cheese_rat',c:8},{t:'octopus_mage',c:5}]}, {e:[{t:'mushroom_scout',c:12},{t:'meat_ogre',c:6},{t:'cheese_golem',c:3}]}, {e:[{t:'fish_knight',c:12},{t:'cheese_rat',c:12},{t:'flour_ghost',c:5}]}, {e:[{t:'mushroom_scout',c:15},{t:'fish_knight',c:8},{t:'cheese_golem',c:3}]}, {e:[{t:'fish_knight',c:11},{t:'cheese_rat',c:13},{t:'meat_ogre',c:6},{t:'cheese_golem',c:2}]} ], svc:{dur:260, intv:3.5, max:28, pat:35} },
  ...
  { id:'6-2', ch:6, waves:[ {e:[{t:'sugar_fairy',c:25},{t:'milk_phantom',c:12}]}, {e:[{t:'shrimp_samurai',c:20},{t:'butter_ghost',c:20}]}, {e:[{t:'sugar_fairy',c:28},{t:'milk_phantom',c:15},{t:'cheese_golem',c:8}]}, {e:[{t:'tomato_bomber',c:22},{t:'fish_knight',c:18}]}, {e:[{t:'sugar_fairy',c:30},{t:'milk_phantom',c:18},{t:'butter_ghost',c:22}]}, {e:[{t:'shrimp_samurai',c:25},{t:'cheese_golem',c:10}]}, {e:[{t:'sugar_fairy',c:32},{t:'milk_phantom',c:20},{t:'tomato_bomber',c:25}]} ], svc:{dur:420, intv:1.6, max:60, pat:22} },
  { id:'6-3', ch:6, waves:[ {e:[{t:'sugar_fairy',c:28},{t:'milk_phantom',c:15}]}, {e:[{t:'shrimp_samurai',c:22},{t:'butter_ghost',c:22}]}, {e:[{t:'sugar_fairy',c:30},{t:'milk_phantom',c:18},{t:'cheese_golem',c:10}]}, {e:[{t:'tomato_bomber',c:25},{t:'fish_knight',c:20}]}, {e:[{t:'sugar_fairy',c:32},{t:'milk_phantom',c:20},{t:'cheese_golem',c:12}]}, {e:[{t:'cuisine_god',c:1}]} ], svc:{dur:480, intv:1.5, max:70, pat:22}, boss:'cuisine_god' },
];
