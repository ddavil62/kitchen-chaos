...
> 최종 업데이트: 2026-04-17
> 기준: Phase 45 완료 / Phase 46-1~3 신규 기획 페이즈 추가 (유랑 미력사·고용 셰프 시스템)
...
Phase 45: 셰프 스프라이트 5종 92x92px 업그레이드 ✅ 완료
              ↓
Phase 46-1: [기획] 미력의 정수 — 희귀 화폐 시스템 설계
              - 화폐 정의 및 획득 경로 (스토리 보상 + 특수 손님 NPC)
              - 특수 손님 NPC 설계 (등장 조건, 연출, 대화)
              - 소비처 및 고용 비용 테이블
              - 경제 밸런스
              ↓
Phase 46-2: [기획] 유랑 미력사 시스템 — 고용 셰프 전체 설계
...
Phase 47: 에셋 통합 검증 + 스크립트 점검
              ...
              ↓
Phase 48: Walk 애니메이션 (범위/비용 검토 후 — 주요 보스 우선 또는 template 제한)
```
