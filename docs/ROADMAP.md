...
> 최종 업데이트: 2026-04-09
> 기준: Phase 10 완료 (캠페인 30스테이지, 레시피 106종, SoundManager, VFXManager)
...
- [ ] EndlessScene (MarketScene 확장) + EndlessWaveGenerator
- [ ] 무한 웨이브 시스템 (HP +12%/wave, 속도 +2%/wave, 10wave마다 보스)
- [ ] "오늘의 스페셜 레시피" (데일리 시드 기반 랜덤 3종, 보상 ×2)
- [ ] 5웨이브 단위 영업 삽입 (TD→영업→TD 반복)
- [ ] 로컬 랭킹 (최고 웨이브, 최고 점수, 최고 콤보)
- [ ] 세이브 v6→v7 마이그레이션 (endless 기록)
- [ ] 6-3 클리어 시 해금, MenuScene 엔드리스 버튼
