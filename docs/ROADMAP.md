...
> 최종 업데이트: 2026-04-23 (Phase 75 행상인 분기 해금 체크 완료, 출시 Polish 로드맵 진행 중)
> 기준: Phase 75 완료 + 출시 Polish 로드맵(Phase 69~78) 계획
...
| **P2 품질 보강** | 72~74 | 분기 카드 수치 전수 반영, 세이브 백업+포트레이트 정합, UI/카피 마감, 행상인 분기 해금 필터(75 fix) | **72~73, 75(fix) 완료**, 74 대기 |
