...
> 최종 업데이트: 2026-04-16
> 기준: Phase 35 완료 (21장 엘 디아블로 최종전, 멕시칸 아크 완결)
...
**현재 구현 완성도**: Phase 35 완료 (시즌3 16~21장 인도+멕시칸 — 적 23종+보스 7종+재료 5종+레시피 67종+스토리 28종+텔레포트/자가회복/혼란/원소저항/다단계/회피/돌진/fireZone/소환/분노 메커닉, 멕시칸 아크 완결)

### 현재 콘텐츠 규모

| 항목 | 수량 |
|------|------|
| 적 종류 | 51종 (일반 38 + 미니보스 1 + 보스 12) |
