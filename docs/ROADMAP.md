...
> 최종 업데이트: 2026-04-10
> 기준: Phase 19-1 완료, Phase 19-2/19-3 진행 중
...
| Phase 19 | 시즌 2 기반 인프라 (월드맵 확장, 신규 캐릭터, 세이브) | 🔧 진행중 |
...
**현재 구현 완성도**: 시즌 1 완성, Phase 19-1 완료 (데이터 레이어 + 세이브 v12 + 도구 전투 로직), 19-2/19-3 진행 중
...
- [ ] ChefSelectScene 5종 셰프 카드 레이아웃 (카드 높이 축소 + 잠금 표시)
- [ ] WorldMapScene 시즌 1/2 탭 전환 (6노드 → 12노드, CHAPTERS 12개)
- [ ] 시즌 2 미해금 시 탭 비활성 + 자물쇠

### 19-3. PixelLab 에셋 + 시즌 2 프롤로그 스토리

- [ ] PixelLab 에셋 6종 (유키/라오 셰프 스프라이트, 초상화, 도구 2종)
- [ ] 시즌 2 프롤로그 대화 스크립트 3종 (season2_prologue, season2_yuki_intro, season2_lao_intro)
- [ ] STORY_TRIGGERS에 트리거 3건 등록
- [ ] season2_prologue 완료 시 season2Unlocked = true
...
| 19 | 시즌 2 기반 (월드맵 12챕터, 셰프 2종, 도구 2종) | 106 | 15 | 🔧 진행중 |
