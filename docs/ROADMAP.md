...
| Phase 17 | 밸런스 QA (수치 시뮬레이션, 병목 탐지, 조정) | 🔄 진행 중 |

**현재 구현 완성도**: Phase 16 완료, Phase 17 밸런스 QA 진행 중
...
## Phase 17 — 밸런스 QA (진행 중)

> 목표: 전체 게임 밸런스 수치 시뮬레이션 분석, 병목 구간 탐지 및 조정

- [ ] DPS vs 적 HP 곡선 분석 (30스테이지 전체)
- [ ] 스테이지별 경제 시뮬레이션 (골드 수입/지출 추이)
- [ ] 레시피 효율 랭킹 (골드/초 기준 OP/함정 레시피 탐지)
- [ ] 난이도 커브 분석 (스테이지 간 점프율, 병목 스테이지)
- [ ] 엔드리스 스케일링 붕괴점 분석
- [ ] 밸런스 조정 제안 및 적용
