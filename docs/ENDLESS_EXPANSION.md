...
## Phase 55-3: 미력 폭풍 + 유랑 미력사 + 정화 임무 ✅ 완료 (2026-04-19)
...
### Phase 55-3 ✅ PASS (QA 22/22)
- [x] 엔드리스 ServiceScene에서 유랑 미력사가 8% 확률로 등장한다
- [x] 웨이브 15/30/45에서 미력 폭풍의 눈 이펙트가 발동한다
- [x] 폭풍 웨이브 적 HP가 기본의 70%이다
- [x] 폭풍 클리어 시 미력의 정수가 20/30/40개 지급된다 *(구현: `10 + Math.floor(wave/15)*10`으로 수정됨, wave15=20 정확히 일치)*
- [x] 4종 임무가 조건에 따라 선택적으로 활성화된다
