...
> 최종 업데이트: 2026-04-28 (Phase 79 인터랙티브 온보딩 재설계 완료)
...
### Phase 78 -- 이진 실패 -> 부분 성공 구조 전환 (2026-04-28)

HP=0이더라도 재료가 1개 이상이면 ServiceScene을 경유하여 50% 재료로 영업하고 별점 최대 2개로 제한하는 부분 성공 경로 추가. 재료=0이면 기존 완전 실패 경로 유지.
