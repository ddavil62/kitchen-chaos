...
> 최종 업데이트: 2026-04-14 (Phase 29-2 완료)
...
| 캠페인 | 24챕터 체계(그룹1~3), 구현 완료 1~7/9~13/15장, 보스 10종, 별점 시스템 | 완료 |
| 레시피 | 186종 (서빙 150 + 버프 36), 5등급, 도감 | 완료 |
...
| 재료 | 23종 |
| 레시피 | 186종 (서빙 150 + 버프 36) |
| 스테이지 | 138슬롯 (구현 완료: 1~7/9~13/15장, placeholder: 8/14/16~24장) |
...
- Phase 30~: 챕터 7~15 밸런스 QA → 그룹3(16~24장) 확장. 상세: `docs/ROADMAP.md`
