...
> 최종 업데이트: 2026-04-28 (Phase 86 미션 아이콘 완성 + updateMode 리팩토링)
...
신규 미션 타입 3종(vip_serve, combo_reach, gold_single_run) 전용 아이콘 3종 생성 및 BootScene/MenuScene 등록. DailyMissionManager recordProgress의 하드코딩 includes 배열을 updateMode 필드 참조로 리팩토링.
...
DAILY_MISSION_POOL 10종 → 20종 확장. 신규 미션 타입 3가지(vip_serve, combo_reach, gold_single_run) 추가. ServiceScene에 미션 연동 훅 3종 삽입.
