...
> 최종 업데이트: 2026-04-28 (Phase 83 TD 씬 배치 피드백 개선 완료)
...
### Phase 83 -- TD 씬 배치 피드백 개선 (2026-04-28)

GatheringScene에 3가지 UX 개선 추가. 팔레트 도구 선택 시 배치 가능 셀(비경로/비점유)에 초록 다이아몬드 오버레이 표시. 배치된 도구 탭 시 사거리 링(반투명 원) 표시. 웨이브 시작 버튼 클릭 후 3->2->1->GO! 카운트다운 실행 후 실제 웨이브 시작.

- QA: PASS (36건, 코드 버그 0건)
- AD 모드 3: APPROVED (WARN 2건: strokeThickness 6px, 색상 하드코딩 - 기존 패턴 일치로 허용)
- 스펙: `.claude/specs/2026-04-28-kc-phase83-planner.md`
