...
> 최종 업데이트: 2026-04-28 (Phase 84 셰프 스킨 시스템 완료)
...
SkinManager 신규 생성(미미 스킨 3종: 기본/핑크/블루 앞치마), ChefSelectScene에 스킨 선택 서브 패널 UI 추가, IAPManager에 스킨 구매 스텁 추가, SaveManager v28 마이그레이션(unlockedSkins/equippedSkin). portrait 에셋 2종(portrait_mimi_pink.png, portrait_mimi_blue.png) PIL 팔레트 교체 생성.
