...
- cellar_phantom(400), sommelier_wraith(380), chef_noir(9000) ENEMY_TYPES 미등록 — 밸런스 시뮬레이션에서 FALLBACK HP 사용 중

## 향후 계획

- 8장 placeholder 스테이지 구현 (일식 아크 일부 완성)
- 14장 placeholder 스테이지 구현 (양식 아크 일부 완성)
- 유키/라오 셰프 스킬 로직 구현
