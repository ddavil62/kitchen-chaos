...
> 최종 업데이트: 2026-04-14 (Phase 27-2 완료)
...
kitchen-chaos/
  js/
    ...
    data/
      ...
      dialogueData.js        # 대화 스크립트 60종 + 캐릭터 10종 정의 (시즌2 7~13장 25종 포함)
...
| 대화 시스템 | DialogueManager.js + DialogueScene.js + dialogueData.js | 대화 스크립트 60종 재생, 선택지 분기 UI, 픽셀아트 초상화 렌더링, 시청 기록 |
...
| 대화/스토리 | DialogueManager+StoryManager, 스크립트 60종, 트리거 56항목, 선택지 분기, 초상화 6종, 10캐릭터, 13장 스토리 포함 | 완료 |
...
- Phase 27-3: 13장 스테이지 + 레시피 구현 (적 등록, 스테이지 13-1~13-5, 트러플 레시피)
