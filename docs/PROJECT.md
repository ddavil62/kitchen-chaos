...
> 최종 업데이트: 2026-04-17 (Phase 41 완료)
...
kitchen-chaos/
  js/
    ...
    data/
      ...
      stageData.js           # 스테이지 데이터 143슬롯 (구현: 1~7/9~13/15~24장, placeholder: 8장/14장 (그룹1~3 구현 완료))
  ...
  assets/                    # 스프라이트/타일셋/아이콘 (PixelLab 픽셀아트)
    ...
    sprites/enemies/         # 적 스프라이트 43종 (macaron_knight 92px, sugar_specter 92px, masala_guide 108px, taco_bandit 160px, burrito_juggernaut 172px 포함)
...
| 23-6 여왕의 호위대 구현 (Phase 41) | 23-6 placeholder → dream_deep 3웨이브, storyData 23-5→23-6 트리거 이동 | 완료 |
...
| 스테이지 | 143슬롯 (구현 완료: 1~7/9~13/15~24장(24-6까지), placeholder: 8장/14장 (그룹1~3 구현 완료)) |
...
- 잔여 placeholder 스테이지 0개 (그룹1~3 전체 구현 완료, 8장/14장 제외)
