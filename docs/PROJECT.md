...
> 최종 업데이트: 2026-04-28 (Phase 78 부분 성공 구조 완료)
...
### Phase 77 -- 엔드리스 해금 완화 + GatheringScene 2x 배속 버튼 (2026-04-27)

엔드리스 모드 해금 조건을 24-6 클리어에서 6-6 클리어로 완화. GatheringScene HUD에 1x/2x 배속 토글 버튼 추가. 세이브 v26->v27 마이그레이션(기존 6-6 클리어 유저 자동 해금).
